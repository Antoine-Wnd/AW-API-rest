...
const models: TsoaRoute.Models = {
    ...
    "IFileRequest": {
        "dataType": "refObject",
        "properties": {
            "folderId": {"dataType":"double","required":true},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/api/users/login',
            ...
            function UserController_login(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    userRequest: {"in":"body","name":"userRequest","required":true,"ref":"IAuthRequestBody"},
            };
        ...
        app.post('/api/users/register',
            ...
            function UserController_register(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    userRequest: {"in":"body","name":"userRequest","required":true,"ref":"IAuthRequestBody"},
            };
        ...
        app.get('/api/folders/:folderId',
            ...
            ...(fetchMiddlewares<RequestHandler>(FolderController.prototype.getChildren)),

            function FolderController_getChildren(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.post('/api/folders',
            ...
            function FolderController_createFolder(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    request: {"in":"body","name":"request","required":true,"ref":"IFolderRequest"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/api/files/:folderId',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(FileController)),
            ...(fetchMiddlewares<RequestHandler>(FileController.prototype.createFile)),

            function FileController_createFile(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    folderId: {"in":"path","name":"folderId","required":true,"dataType":"double"},
        ...
        app.delete('/api/files/:fileId',
            ...
            function FileController_deleteFile(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.get('/api/files/:fileId',
            ...
            function FileController_downloadFile(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    fileId: {"in":"path","name":"fileId","required":true,"dataType":"double"},
            };
